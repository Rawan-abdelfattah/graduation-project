...
function SignIn() {
  ...
  return (
    <DefaultAuth illustrationBackground={illustrationDoc} image={illustrationDoc}>
      ...
      <Flex
        ...
        <Box me='auto'>
          ...
          <Text
            ...
            fontSize='md'
            maxW="400px">
            sign in to your account to manage your health and services and appointments effectivily
          </Text>
        </Box>
        <Flex
          zIndex='2'
